...
### vJS4.10 (Current)
- ✅ Updated preloading to limit to 20 most recent emails when inbox opens
- ✅ Added date-based sorting to ensure most recent conversations are preloaded first
- ✅ Improved inbox preloading performance by prioritizing current conversation
- ✅ Preloads complete order data (order numbers, shipping addresses, tracking, serial numbers) for 20 most recent emails
