// Missive JS API variant (vJS5.09)
...
class MissiveJSBridge {
  ...
  init() {
    console.log('🚀 Initializing MissiveJSBridge...');
      ...
      // Force version badge to vJS5.09 immediately
        this.setBadge('vJS5.09');
    console.log('🔧 Set initial version badge to vJS5.09');
      ...
      if (window.config && window.MissWooApp) {
        ...
        if (this.app && this.app.updateHeaderWithVersion) {
          ...
          this.app.updateHeaderWithVersion = () => {
            ...
            setTimeout(() => this.setBadge('vJS5.09'), 100);
          };
        }
  ...
  bindManualSearchEvents() {
    ...
    window.MissWooDebug = {
      ...
      checkVersionBadge: () => {
        ...
        if (el) {
          el.textContent = 'vJS5.09';
          console.log('🧪 Forced version badge to vJS5.09');
        }
