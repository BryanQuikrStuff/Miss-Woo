// Missive JS API variant (vJS4.06)
...
class MissiveJSBridge {
  ...
  init() {
    ...
    // Force version badge to vJS4.06 immediately
        this.setBadge('vJS4.06');
    console.log('🔧 Set initial version badge to vJS4.06');
  ...
  initializeApp() {
    try {
      ...
      if (window.config && window.MissWooApp) {
        ...
        // Override version badge to vJS4.06 once app updates header
        setTimeout(() => this.setBadge('vJS4.06'), 300);
        
        // Additional aggressive version setting to ensure it shows
        setTimeout(() => this.setBadge('vJS4.06'), 1000);
        setTimeout(() => this.setBadge('vJS4.06'), 2000);
        setTimeout(() => this.setBadge('vJS4.06'), 3000);
        setTimeout(() => this.setBadge('vJS4.06'), 5000);
        ...
        if (this.app && this.app.updateHeaderWithVersion) {
          ...
          this.app.updateHeaderWithVersion = () => {
            ...
            setTimeout(() => this.setBadge('vJS4.06'), 100);
          };
        }
  ...
  bindManualSearchEvents() {
    ...
    window.MissWooDebug = {
      ...
      checkVersionBadge: () => {
        ...
        if (el) {
          el.textContent = 'vJS4.06';
          console.log('🧪 Forced version badge to vJS4.06');
        }
