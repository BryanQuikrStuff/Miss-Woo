// Missive JS API variant (vJS5.14)
...
class MissiveJSBridge {
  ...
  init() {
    console.log('🚀 Initializing MissiveJSBridge...');
      ...
      // Force version badge to vJS5.14 immediately
        this.setBadge('vJS5.14');
    console.log('🔧 Set initial version badge to vJS5.14');
      ...
      if (window.config && window.MissWooApp) {
        ...
        if (this.app && this.app.updateHeaderWithVersion) {
          ...
          this.app.updateHeaderWithVersion = () => {
            ...
            setTimeout(() => this.setBadge('vJS5.14'), 100);
          };
        }
  ...
  bindManualSearchEvents() {
    ...
    window.MissWooDebug = {
      ...
      checkVersionBadge: () => {
        ...
        if (el) {
          el.textContent = 'vJS5.14';
          console.log('🧪 Forced version badge to vJS5.14');
        }
