// Missive JS API variant (vJS5.16)
...
class MissiveJSBridge {
  ...
  init() {
    console.log('🚀 Initializing MissiveJSBridge...');
      ...
      // Force version badge to vJS5.16 immediately
        this.setBadge('vJS5.16');
    console.log('🔧 Set initial version badge to vJS5.16');
      ...
      if (window.config && window.MissWooApp) {
        ...
        if (this.app && this.app.updateHeaderWithVersion) {
          ...
          this.app.updateHeaderWithVersion = () => {
            ...
            setTimeout(() => this.setBadge('vJS5.16'), 100);
          };
        }
  ...
  bindManualSearchEvents() {
    ...
    window.MissWooDebug = {
      ...
      checkVersionBadge: () => {
        ...
        if (el) {
          el.textContent = 'vJS5.16';
          console.log('🧪 Forced version badge to vJS5.16');
        }
