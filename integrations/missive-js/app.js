...
//
// As of vJS5.29 this bridge no longer subscribes to Missive events. The
...
// `Missive.on` wrapper were removed in vJS5.29 since `src/app.js` has
// always had its own equivalent wait machinery.

const VERSION_BADGE_TEXT = 'vJS5.29';
